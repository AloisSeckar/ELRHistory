...
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #1', 1, now() - INTERVAL '6 hour');
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #2', 1, now() - INTERVAL '5 hour');
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #3', 1, now() - INTERVAL '4 hour');
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #4', 1, now() - INTERVAL '3 hour');
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #5', 1, now() - INTERVAL '2 hour');
INSERT INTO "elrh_news"("content", "authorId", "dateCreated") VALUES ('Test news #6', 1, now() - INTERVAL '1 hour');
...
INSERT INTO "elrh_link"("categoryId", "ord", "dateCreated", "dateEdited", "name", "dscr", "url", "thumb", "authorId") VALUES 
...
INSERT INTO "elrh_book"("categoryId", "ord", "dateCreated", "dateEdited", "writer", "name", "dscr", "url", "thumb", "review", "year", "authorId")
...
INSERT INTO "elrh_article"("categoryId", "dateCreated", "dateEdited", "name", "dscr", "content", "thumb", "authorId", "galleryId") 
...
INSERT INTO "elrh_gallery"("dateCreated", "dateEdited", "name", "dscr", "authorId", "parentId") VALUES
...
INSERT INTO "elrh_image"("dateCreated", "dateEdited", "name", "dscr", "authorId", "image", "galleryId", "ord") VALUES 
...
UPDATE "elrh_image" SET "nextId" = 2 WHERE "imageId" = 1;
UPDATE "elrh_image" SET "prevId" = 1, "nextId" = 3 WHERE "imageId" = 2;
UPDATE "elrh_image" SET "prevId" = 2, "nextId" = 4 WHERE "imageId" = 3;
UPDATE "elrh_image" SET "prevId" = 3, "nextId" = 5 WHERE "imageId" = 4;
UPDATE "elrh_image" SET "prevId" = 4, "nextId" = 6 WHERE "imageId" = 5;
UPDATE "elrh_image" SET "prevId" = 5, "nextId" = 7 WHERE "imageId" = 6;
UPDATE "elrh_image" SET "prevId" = 6, "nextId" = 8 WHERE "imageId" = 7;
UPDATE "elrh_image" SET "prevId" = 7 WHERE "imageId" = 8;
