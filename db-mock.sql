...
INSERT INTO "elrh_gallery" VALUES (3, now(), now(), 'Test empty gallery', 'This one will contain no images, but it has long description,
...
INSERT INTO "elrh_gallery" VALUES (4, now(), now(), 'Test gallery with no dscr', null, 1, null);
