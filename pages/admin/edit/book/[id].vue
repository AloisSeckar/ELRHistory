<template>
  <div>
    <AdminFormSelectItem :label="useTAdminSelect('book')" :options="bookOptions" :selected="selected" @select-item="changeItem" />
    <h2>{{ useTAdminEdit('book') }}: <strong>{{ currentBookName }}</strong></h2>
