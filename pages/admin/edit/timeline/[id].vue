<template>
  <div>
    <AdminFormSelectItem :label="useTAdminSelect('timeline')" :options="timelineOptions" :selected="selected" @select-item="changeItem" />
    <h2>{{ useTAdminEdit('timeline') }}: <strong>{{ currentTimelineName }}</strong></h2>
